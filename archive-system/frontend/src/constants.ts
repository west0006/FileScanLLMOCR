...
export const MOCK_YEAR_LIST = [
  { year: 2025, count: 12300 },
  { year: 2024, count: 11800 },
  { year: 2023, count: 10500 },
  { year: 2022, count: 9800 },
  { year: 2021, count: 9200 },
  { year: 2020, count: 8900 },
  { year: 2010, count: 7500 },
  { year: 2000, count: 6800 },
  { year: 1990, count: 5200 },
  { year: 1980, count: 3400 },
  { year: 1970, count: 2100 },
];
...
export const MOCK_ACTIVITIES = [
  {
    type: "search",
    desc: '用户"管理员"检索了关键词"招生 1996"',
    time: "2 分钟前",
  },
  {
    type: "review",
    desc: "AI 预审任务 REV-2026-001 完成 560 件",
    time: "15 分钟前",
  },
  {
    type: "ocr",
    desc: 'OCR 任务"历史档案补录"处理完成 2400 页',
    time: "1 小时前",
  },
  {
    type: "system",
    desc: "文件增量同步完成，新增 125 个文件",
    time: "2 小时前",
  },
...
export const MOCK_STATS_TYPE = [
  { type: "search", count: 342 },
  { type: "view", count: 156 },
  { type: "review", count: 89 },
  { type: "download", count: 45 },
  { type: "print", count: 23 },
  { type: "login", count: 198 },
];
...
export const MOCK_REVIEW_FALLBACK = {
  ...
  suggestion: "建议部分开放",
  reason:
    "该档案引用了上级单位来文，且包含部分个人隐私信息。建议对相关段落做遮盖脱敏处理后开放其余内容。",
  sensitive_items: [
    {
      type: "上级来文引用",
      content: "根据国务院[1973]XX号文件精神...",
      start_char: 50,
      end_char: 80,
    },
    {
      type: "个人隐私",
      content: "学生张三，家庭出身地主，父亲张某某...",
      start_char: 200,
      end_char: 235,
    },
    {
...
// ============================================================
// 目录树授权数据（与后端 _TREE_HIERARCHY 一致：门类 → 部门）
// ============================================================

export const TREE_AUTH_DATA: Record<string, string[]> = {
